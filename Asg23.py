...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/asgharmalik37/hpro/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923091361370')
        reg()
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;31;1m[Asgahr-CP] ' + uid + ' | ' + pass4
                            cp = open('Asghar_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
